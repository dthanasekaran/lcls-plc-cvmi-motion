...
#
#         Project: lcls-plc-cvmi-motion.tsproj
#        PLC name: cvmi_motion (cvmi_motion Instance)
# Generated using: pytmc 2.18.2
# Project version: unknown
#    Project hash: unknown
#     PLC IP/host: 172.21.68.243
#      PLC Net ID: 172.21.68.243.1.1
...
epicsEnvSet("IPADDR",           "172.21.68.243")
epicsEnvSet("AMSID",            "172.21.68.243.1.1")
...
system("${ADS_IOC_TOP}/scripts/add_route.sh 172.21.68.243 ^172.*$")
...
epicsEnvSet("MOTOR_PREFIX",    "CXI:CVMI:MMS:")
...
epicsEnvSet("DESC",            "Main.M4 / SamplePaddle")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=$(ASYN_PORT),PREFIX=PLC:CVMI:MOTION,IDX=1,TASK_PORT=350")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=$(ASYN_PORT), PREFIX=PLC:CVMI:MOTION")

dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:CVMI:MOTION,PROJECT=lcls-plc-cvmi-motion.tsproj,HASH=unknown,VERSION=unknown,PYTMC=2.18.2,PLC_HOST=172.21.68.243")

#   LCLS General: * -> 2.12.0 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:CVMI:MOTION,DEPENDENCY=LCLS_General,VERSION=2.12.0,VENDOR=SLAC")
#   Tc2_MC2: * -> 3.3.69.0 (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:CVMI:MOTION,DEPENDENCY=Tc2_MC2,VERSION=3.3.69.0,VENDOR=Beckhoff Automation GmbH")
#   Tc2_Standard: * -> 3.4.5.0 (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:CVMI:MOTION,DEPENDENCY=Tc2_Standard,VERSION=3.4.5.0,VENDOR=Beckhoff Automation GmbH")
#   Tc2_System: * -> 3.9.1.0 (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:CVMI:MOTION,DEPENDENCY=Tc2_System,VERSION=3.9.1.0,VENDOR=Beckhoff Automation GmbH")
#   Tc2_Utilities: * -> 3.9.2.0 (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:CVMI:MOTION,DEPENDENCY=Tc2_Utilities,VERSION=3.9.2.0,VENDOR=Beckhoff Automation GmbH")
#   Tc3_Module: * -> 3.4.5.0 (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:CVMI:MOTION,DEPENDENCY=Tc3_Module,VERSION=3.4.5.0,VENDOR=Beckhoff Automation GmbH")

cd "$(IOC_TOP)"

## PLC Project Database files ##
dbLoadRecords("cvmi_motion.db", "PORT=$(ASYN_PORT),PREFIX=PLC:CVMI:MOTION:,IOCNAME=$(IOC),IOC=$(IOC)")
